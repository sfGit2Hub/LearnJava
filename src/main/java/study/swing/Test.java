...
public class Test extends JFrame {
    ...
    class MenuTest extends JMenuBar {
        ...
        public MenuTest() {
            ...
            aboutMenuItem.addActionListener(e -> aboutDialog.show());
    ...
    class RightPanel extends JPanel {
        ...
        public RightPanel() {
            ...
            button.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (resule == file.APPROVE_OPTION) {
                        ...
                        JOptionPane.showConfirmDialog(null, dir + "\\" + fileName, "选择的文件", JOptionPane.OK_OPTION);
            ...
            DefaultListModel<String> litem = new DefaultListModel<String>();

            litem.addElement("香蕉");

            litem.addElement("水果");

            JList<String> list = new JList<String>(litem);
